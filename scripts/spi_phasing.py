...
if __name__ == '__main__':
    ...
    parser.add_argument("--stacking", action="store_true", default=False, help="Set to tell the program that the input data are stacked by a number of patterns.")
    parser.add_argument("--mask_file", type=str, default="none", help="Input mask file, which stores only one single mask, support npy and HDF5 file format, default is none.")
