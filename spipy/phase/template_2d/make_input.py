...
def make_input(args_config):
    ...
    print('\n Loading: ' + str(params['input']['fnam']) + ' as ' + str(dtype) + ' with shape ' + str(shape))
    ...
    if params['input']['inner_mask'] is not None :
        print('\n masking the central ' + str(params['input']['inner_mask']) + ' pixels')
    ...
    if params['input']['outer_mask'] is not None :
        print('\n setting the outer ' + str(params['input']['outer_mask']) + ' pixels to zero')
    ...
    if params['input']['outer_outer_mask'] is not None :
        print('\n allowing pixels between ' + str(params['input']['outer_mask']) + \
                ' and ' + str(params['input']['outer_outer_mask']) + ' to float')
    ...
    if params['input']['subtract_percentile'] is not None :
        print('\n subtracting the ' + str(params['input']['subtract_percentile']) + \
